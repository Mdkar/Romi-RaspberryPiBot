...
int16_t spinSpeed = 200;
int spindirection = 1;


void spin()
{
  int lstart = encoders.getCountsLeft();
  while(abs(encoders.getCountsLeft() - lstart) < 1500)
    motors.setSpeeds(spinSpeed*spindirection, -spinSpeed*spindirection);
